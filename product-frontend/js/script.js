...
//OnLoad
loadCategories(); //ele carrega primeiro as categorias, pois é sincrona
loadProducts();
...
function save() {
    ...
    $.ajax({
        ...
        error: (err) => {
            console.log("Erro ao salvar o produto:", err);  // Exibe o erro caso haja falha
        }
    });
